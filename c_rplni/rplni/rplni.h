...
int rplni_scope_export_ptrlist(struct rplni_scope* scope, struct rplni_ptrlist* list, struct rplni_scope* scope2, int ignore_elements);
...
int rplni_ptrlist_init(struct rplni_ptrlist *nodes);
